...
class TestHappyNewYear(unittest.TestCase):
...
class TestSquareIntegers(unittest.TestCase):
    ...
    def test_prints_1_to_100_fizzbuzz(self):
        ...
        for line in answer.split('\n'):
            if line:  # answer.split(\n) produces a list that ends in ''
                if i % 15 == 0:
                    assert line == "FizzBuzz", f"Should have printed 'Buzz' when the number is {i}, got {line} instead"
                elif i % 3 == 0:
                    assert line == "Fizz", f"Should have printed 'Fizz' when the number is {i}, got {line} instead"
                elif i % 5 == 0:
                    assert line == "Buzz", f"Should have printed 'Buzz' when the number is {i}, got {line} instead"
                else:
